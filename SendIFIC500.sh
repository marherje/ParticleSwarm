...
source $ORIGIN/init_ilcsoft_v02-02-01.sh
...
export CXX=g++
export CC=gcc
source /cvmfs/ilc.desy.de/sw/x86_64_gcc82_centos7/v02-02-01/root/6.18.04/bin/thisroot.sh

for pol in eLpR #eRpL
do
    for cat in catA #catB catC catD
    do
	python runPSO.py -c FlavourTag500IFIC/FlavourTag500IFIC_${pol}_${cat}.txt -o FlavourTag500IFIC_${pol}_${cat} > LogFlavourTag500IFIC_${pol}_${cat}
    done
done
